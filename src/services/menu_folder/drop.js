...
const editMenuFolder = async (uname, token, index, oldIndex) => {
  try {
    ...
    const response = await axios.post(`${uri}/edit/menu_folder/drop/`, data, config)
    .then((response) => {
